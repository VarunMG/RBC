...
#RaBase_SS = RBC_Problem(10500,7,1.5585,128,64)
#RaBase_SS.initialize()
#uArr, vArr, bArr, phiArr, dt = open_fields('/grad/gudibanda/RBC/steady_states/Pr7/primary_box/Nx128Nz64/Ra10000Pr7alpha1.5585Nx128Nz64_SS.npy')
#RaBase_SS_guess = arrsToStateVec(phiArr, bArr)
#X, iters = findSteadyState2(RaBase_SS, RaBase_SS_guess, 2.0, 1e-6, 20,True)
#RaBase_SS.saveToFile('Ra10500Pr7alpha1.5585Nx128Nz64_SS_run2.npy')
...
#uArr, vArr, bArr, phiArr, dt = open_fields('Ra363500Pr100alpha1.5585Nx256Nz128_SS.npy')
# inputs for follow branch are like: follow_branch(Pr,alpha,Ra_start,Ra_end,Ra_step, Nx, Nz, startingGuess, starting_dt, tol)

#uArr, vArr, bArr, phiArr, dt = open_fields('/grad/gudibanda/RBC/steady_states/Pr7/primary_box/Nx60Nz60/Ra10000Pr7alpha1.5585Nx60Nz60_SS.npy')
#starting_SS_state = arrsToStateVec(phiArr, bArr)
#startingGuess = starting_SS_state
#starting_dt = dt
#RaVals, NuVals, steady_states = follow_branch(100,1.5585,364000,1000000, 1000, 256, 128, startingGuess, starting_dt, 1e-6)
